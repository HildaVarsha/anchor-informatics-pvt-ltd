    ...
    <div className="px-4 md:px-0 pb-24 container mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        {FOUNDERS?.map((item, index)=>{
          ...
          <Image
            src={
              item.image||"https://images.pexels.com/photos/3183146/pexels-photo-3183146.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            }
            alt={item.name}
            width={100}
            height={100}
            ...
            />
          <div className="p-4">
            <h1 className="text-3xl font-bold pb-4">{item.name} {item.role}</h1>
